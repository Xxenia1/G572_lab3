...
(function(){
    ...
    function createMap(){
        ...
        map = L.map("map",{
            center:L.latLng(43.0748, -89.3978),
            zoom:16,
            maxZoom:18,
            minZoom:12
        });
    ...
    function routeClass(props) {
        ...
        if (!elem) {
            console.warn(`Element with class "route-${props.id}" not found.`);
            return; 
        }
    ...
    function openModal(props){
        ...
        if (props.image){
            let img = "<img src='bucky_image/" + props.image + "' id='stop-img'>"
